...
MoveLocal(self) ==
  \E childCur \in ({edge.child: edge \in treeSet[self]} \union {timeSelf[self]}),
     parentNew \in ({edge.child: edge \in treeSet[self]} \union {RootNode} \union {TrashNode}),
     metaNew \in Meta:
...
InvEmprtyLogAndTree == \A self \in Workers: logMove[self] = <<>> <=> treeSet[self] = {}
...
THEOREM Spec => [](TypeOK /\ InvOneParent /\ InvTwoBeginnings /\ InvEmprtyLogAndTree 
                   /\ ModelConstSizeLogMove /\ ModelConstSizeTreeSet /\ ModelConstSizeQueue)

=============================================================================
\* Modification History
\* Last modified Thu Jul 27 21:13:25 IRKT 2023 by ilyabarishnikov
