...
InvTwoMoveTime ==
  \A self \in Workers:
  \A log1 \in ToSet(logMove[self]), log2 \in ToSet(logMove[self]):
  log1 = log2 \/ log1.log_time # log2.log_time
...
\* Last modified Thu Jul 27 22:53:19 IRKT 2023 by ilyabarishnikov
